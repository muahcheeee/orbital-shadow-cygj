...
function showHelp()
{
  var msg = "If you wish to guess the letters 'A', 'E' , 'I' in sequence, enter 'a' followed by 'ae', then 'aei'. Do not backspace any letters for the programme to record your number of guesses.";
  alert(msg);
}
</script>
...
<BODY onLoad="document.theDetails.gameLength.value=guessChoices.length;">
  ...
  <div align=center>
    <table border=0 cellpadding=3>
     <tr>
      <td  valign=top align=center><font size=7 face="arial black"><center>Hangman</center></font>
        <font size=2 face="arial" color="#685dab"><b><div align=left>1. Select a category:</font><br>
        <table border=1 cellpadding=9 cellspacing=0 bordercolor="black" bgcolor="#ffffc6" width=290>
          <form name="myForm">
            <tr>
             <td align=center>
               
              <font size=2><b> Capital Cities <input type="radio" name="categories" value="capitals" onClick="renameBut(this.value);">               
               Countries <input type="radio" name="categories" value="countries" onClick="renameBut(this.value);">
             </td>
           </tr>
         </table><br> <div align=left>
         
         <font size="2" color="#685dab"><b>2. Activate Random  </b></font><font size="2"><input type="button" name="start" value="Country/Capital" onClick="newGame();"><p>
         <font size="3" face="arial"><center><input type="text" size="43" name="toGuess" readonly><br>
          ...
          <table><tr><td align=left>
            <font size=2 color="#685dab">
              <u><b>Rules of the game:</b></u><br>
              1. Choose a category.<br>
              2. Activate a random word.<br>
              3. Guess letter one at a time then push "Enter" button.<br>
            </font>
          </td></tr></table>
          
          <font size=2 color="#685dab"><b>3. </font><font size=3><input type="text" name="input" size=35></font> <input type="button" value="Enter" onClick="makeAGuess();"><input type="button" onclick='showHelp()' value='Help'><br> <!---->
          <div align=left>
            <font size=2 color=red><b><i>Warning!</b></font> <font size=1 color="#000000"><i>You only have </i></font><font size=3 face=arial><input type="text" name="counter" value="" size=2 maxlength=2 disabled></font><font size=1 color="#000000"><i> bad guess before you lose!.</i></font>
          </form>
          
        </td></tr>
        <tr><td align=center  valign="top">
         
          <table border=3 cellpadding=5 cellspacing=0 bordercolor=black bgcolor="white" width="">
            <tr><td>
              <table  border=0 cellpadding=1 cellspacing=0 bgcolor="#ffffff">
                <div align=right>
                  <form name="theDetails">
                    <tr><td  colspan=2 align=center><font size="5" face="Arial Black"><b>Statistics & Facts</font></td>
                    </tr>
                    <tr>
                      <td align=right width="130"><font size=2>City Capital: </td><td width=><input type="text" name="country" size="35" disabled></td>
                    </tr>
                    <tr>
                     <td align=right><font size=2>Country's Name: </td><td><input type="text" name="capital" size="25" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Location: </td><td><input type="text" name="location" size="35" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Langauage: </td><td><input type="text" name="language" size="22" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Neighbours: </td><td><textarea name="neighbours" cols="28" rows="6" disabled wrap></textarea></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Population <font size=1>(2001)</font>: </td><td><input type="text" name="population" size="22" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Literacy Rate: </td><td><input type="text" name="literacy" size="22" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Area: </td><td><input type="text" name="area" size="22" disabled></td>
                   </tr>
                   <tr>
                     <td align=right><font size=2>Currency: </td><td><input type="text" name="currency" size="22" disabled></td>
                   </tr>
                   <tr><td colspan=2><center>_________________________________________</center></td>
                    <tr><td colspan=2><font size=2><b>Note.</b> The number of Countries/Capital Cities enlisted in the Game is: </font><input type="text" name="gameLength" size=3 readonly><font size=2> so far.</font></td>
                    </tr>
                  </form>
                </div>
              </table>
